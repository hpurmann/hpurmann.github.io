...
Explaining git can be a challenging task. For instance, last week [I wrote about moving commits to another branch](http://hpurmann.com/2015/03/28/git-moving-commits-to-another-branch/).
...
For an [insight into my workflow, see the following post](http://hpurmann.com/2015/04/12/gitdags-my-workflow/).
